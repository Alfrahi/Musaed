...
const TaskStatus = () => {
  ...
  if (shouldReduceMotion) {
    return (
      <div className="shadow-native flex items-center gap-3 rounded-md border border-zinc-200 bg-zinc-100 py-1.5 ps-3 pe-4 dark:border-zinc-700 dark:bg-zinc-800/80">
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="shadow-native flex items-center gap-3 rounded-md border border-zinc-200 bg-zinc-100 py-1.5 ps-3 pe-4 dark:border-zinc-700 dark:bg-zinc-800/80"
      >
        <div className="relative flex items-center justify-center">
          <Loader2 size={14} className="animate-spin text-blue-500" aria-hidden="true" />
          {status?.progress !== undefined && (
