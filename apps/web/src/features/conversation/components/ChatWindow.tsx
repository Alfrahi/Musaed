...
const ScrollButton = ({
  ...
  <div className="inset-be-6 pointer-events-none absolute start-1/2 z-20 flex -translate-x-1/2 justify-center">
    <Button
      ...
      size="icon"
      onClick={onClick}
      className="shadow-pro focus-ring pointer-events-auto relative rounded-md border-zinc-200 bg-white text-zinc-500 hover:text-blue-500 active:scale-95 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300"
      aria-label={label}
    >
      <ArrowDown size={20} />
      {unreadCount > 0 && (
