...
const NoModelsOnboarding = ({
  ...
  <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
    ...
    <Button
      ...
      className="gap-3 rounded-none shadow-lg"
    >
      <Download size={18} />
...
const OllamaOfflineOnboarding = ({
  ...
  <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
    ...
    <Button
      ...
      className="gap-3 rounded-none border-red-200 text-red-600 shadow-lg hover:bg-red-50 active:scale-95 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-950/30"
    >
      <WifiOff size={18} />
    ...
    <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
      ...
      <div className="grid w-full max-w-lg grid-cols-1 gap-4 sm:grid-cols-2">
        <Button
          ...
          className="group h-auto gap-4 rounded-none border-zinc-200 bg-white p-4 text-start hover:border-blue-500 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-blue-500"
        >
