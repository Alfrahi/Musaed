...
const NoModelsOnboarding = ({
  ...
  <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
    <div className="mbe-8 relative">
      <div className="shadow-pro flex h-20 w-20 rotate-3 items-center justify-center rounded-md border border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-900/30">
        <Download size={40} className="text-amber-600" />
      </div>
      <div className="inset-be-[-0.5rem] inset-ie-[-0.5rem] shadow-pro absolute flex h-8 w-8 -rotate-12 items-center justify-center rounded-md bg-amber-600 text-white">
        <Sparkles size={16} />
      </div>
    </div>
...
const OllamaOfflineOnboarding = ({
  ...
  <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
    <div className="mbe-8 relative">
      <div className="shadow-pro flex h-20 w-20 rotate-3 items-center justify-center rounded-md border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/30">
        <WifiOff size={40} className="text-red-600" />
      </div>
      <div className="inset-be-[-0.5rem] inset-ie-[-0.5rem] shadow-pro absolute flex h-8 w-8 -rotate-12 items-center justify-center rounded-md bg-red-600 text-white">
        <Sparkles size={16} />
      </div>
    </div>
    <h2 className="mbe-2 text-2xl font-black tracking-tight text-zinc-900 dark:text-zinc-100">
...
const EmptyState = ({ onboarding }: { onboarding?: OnboardingState }) => {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50/30 ps-8 pe-8 dark:bg-zinc-950">
      <div className="mbe-8 relative">
        <div className="shadow-pro flex h-20 w-20 rotate-3 items-center justify-center rounded-md border border-zinc-100 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          <Bot size={40} className="text-blue-600" />
        </div>
        <div className="inset-be-[-0.5rem] inset-ie-[-0.5rem] shadow-pro absolute flex h-8 w-8 -rotate-12 items-center justify-center rounded-md bg-blue-600 text-white">
          <Sparkles size={16} />
        </div>
      </div>
