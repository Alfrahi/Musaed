...
const TabButtons = ({
  ...
  <div className="mb-4 flex gap-1 px-4">
    <button
      ...
      className={`caption-xs duration-fast flex flex-1 items-center justify-center gap-1.5 rounded-md py-1.5 font-bold tracking-wider uppercase transition-all ${
        activeTab === 'chats'
