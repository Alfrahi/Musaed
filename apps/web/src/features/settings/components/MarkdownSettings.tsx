      ...
      <div className="flex flex-col gap-3">
        {toggles.map((toggle) => {
          ...
          return (
            <div 
              key={toggle.id}
              className="flex items-start gap-4 p-3 bg-zinc-50 dark:bg-zinc-800 rounded-xl border border-zinc-100 dark:border-zinc-700"
            >
              ...
              <button
                onClick={() => updateGlobalSettings({ [toggle.id]: !isEnabled })}
