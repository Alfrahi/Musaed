...
pub use crate::shared::{
    ...
    EVENT_OLLAMA_TOKEN, EVENT_PULL_ERROR, EVENT_PULL_PROGRESS, FAST_HTTP_CLIENT, FAST_TIMEOUT_SECS,
    HTTP_CLIENT, INITIAL_REQUEST_TIMEOUT_SECS, MAX_TOTAL_IMAGE_SIZE_BYTES, PULL_ABORT_HANDLES,
